...
const I18N = {
  ...
  ta: {
    dashboard: 'முகப்பு', customers: 'வாடிக்கையாளர்கள்', newCustomer: 'புதிய வாடிக்கையாளர்',
    billing: 'வசூல் / பில்', ledger: 'வாடிக்கையாளர் கணக்கு', pending: 'நிலுவைத் தொகை',
    boxes: 'பெட்டி இருப்பு', reports: 'அறிக்கைகள்', masters: 'அடிப்படை அமைப்பு', settings: 'அமைப்புகள்',
    monthBill: 'மாத இறுதி', expenses: 'செலவுகள்', cancelled: 'ரத்து செய்யப்பட்ட பில்கள்',
    appearance: 'தோற்றம்', theme: 'நிறத் தோற்றம்', language: 'மொழி',
    themeHint: 'தோற்றமும் மொழியும் இந்த சாதனத்தில் சேமிக்கப்படும்',
    collection: 'வசூல்', logout: 'வெளியேறு',
    navMain: 'முதன்மை', navBoxes: 'பெட்டிகள்', navReports: 'அறிக்கைகள்', navSetup: 'அமைப்பு',
    navFinance: 'நிதி', navSystem: 'கணினி',
    streets: 'தெருக்கள்', packages: 'திட்டங்கள்', mso: 'MSO', collectors: 'வசூல் ஏஜென்ட்கள்', company: 'நிறுவனம்',
    secCollection: 'வசூல்', secCustomers: 'வாடிக்கையாளர்கள்', secService: 'சேவை',
    secBilling: 'பில்லிங்', secAudit: 'கணக்காய்வு', secAnalytics: 'பகுப்பாய்வு',
    repCollection: 'வசூல் அறிக்கை', repCustomerList: 'வாடிக்கையாளர் பட்டியல்', repPending: 'நிலுவைப் பட்டியல்',
    repDc: 'துண்டிப்புப் பட்டியல்', repNewConn: 'புதிய இணைப்பு', repTransfer: 'இடமாற்ற அறிக்கை',
    repPackage: 'திட்டம் வாரியாக', repPayMode: 'செலுத்தும் முறை', repColAudit: 'வசூல் கணக்காய்வு',
    repActivity: 'செயல்பாட்டுப் பதிவு', repTrend: 'வசூல் போக்கு',
    save: 'சேமி', cancel: 'ரத்து', search: 'தேடு', print: 'அச்சு', show: 'காட்டு',
    today: 'இன்று', thisMonth: 'இந்த மாதம்', total: 'மொத்தம்', active: 'செயலில்', due: 'நிலுவை',
    dashToday: 'இன்றைய வசூல்', dashLive: 'நேரடி · இன்று', dashMonth: 'இந்த மாத வசூல்',
    dashThisMonth: 'இந்த மாதம்', dashTotalDue: 'மொத்த நிலுவை', dashPendingCust: 'நிலுவை வாடிக்கையாளர்',
    dashNetwork: 'பிணைய மேலோட்டம்', dashCustomers: 'வாடிக்கையாளர்கள்', dashTotalBox: 'மொத்த பெட்டி',
    dashWithCust: 'வாடிக்கையாளரிடம்', dashInStore: 'கிடங்கில்', dashByAgent: 'ஏஜென்ட் வசூல்',
    dashQuick: 'விரைவுச் செயல்கள்', dashOutPay: 'நிலுவைப் பணம்', dashManageSub: 'வாடிக்கையாளர் மேலாண்மை',
    dashBoxMgmt: 'பெட்டி மேலாண்மை', dashTrackStb: 'பெட்டி / இருப்பு', dashNextBill: 'அடுத்த மாத பில்',
    dashGenOnce: 'மாதத்திற்கு ஒரு முறை மட்டும்', dashNewCust: 'புதிய வாடிக்கையாளர்', dashAddSub: 'புதிய இணைப்பு சேர்',
    dashCreateBill: 'பில் உருவாக்கு', dashGenBill: 'மாத பில் உருவாக்கு',
    dashColToday: 'இன்று', dashColMonth: 'இந்த மாதம்', dashAgent: 'ஏஜென்ட்',
    activePct: '% செயலில்'
  }
};
